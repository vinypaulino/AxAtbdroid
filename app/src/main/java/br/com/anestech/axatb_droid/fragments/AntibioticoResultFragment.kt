...
class AntibioticoResultFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AntibioticoResultFragment.
         */
        // TODO: Rename and change types and number of parameters
        fun newInstance(param1: String, param2: String): AntibioticoResultFragment {
            val fragment = AntibioticoResultFragment()
            val args = Bundle()
